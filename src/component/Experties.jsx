...
function Experties() {
  return (
    ...
    <h2 className='my-8 text-center text-3xl tracking-tighter lg:text4xl '>Our Expertise</h2>
    <div className='container mx-auto px-4'>
        {CUSINES.map ((cusion,index) =>(
          <div key={index} className="flex items-center border-b-4 border-dotted border-neutral-700/40 py-2">
            <div className='flex-shrink-0 pr-8 text-2xl'>{cusion.number}
            </div>

            <div className='w-1/3 flex-shrink-0'>
            <img src={cusion.image}
                 alt={cusion.title}
